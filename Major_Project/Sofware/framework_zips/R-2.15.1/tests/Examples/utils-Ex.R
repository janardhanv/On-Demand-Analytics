...
##D ## but not in a way that codetools can find.  In the same source file
##D ## (to remind you that you did it) add:
##D utils::globalVariables(c(".obj1", "obj2"))
## End(Not run)
...
##D help.start(remote=paste("file://", R.home(), sep=""))
## End(Not run)
...
## Not run: 
##D install.packages(
##D     c("XML_0.99-5.tar.gz",
##D       "../../Interfaces/Perl/RSPerl_0.8-0.tar.gz"),
##D     repos = NULL,
##D     configure.args = c(XML = '--with-xml-config=xml-config',
##D                        RSPerl = "--with-modules='IO Fcntl'"))
## End(Not run)
...
### Aliases: update.packages old.packages new.packages
### Keywords: utilities
