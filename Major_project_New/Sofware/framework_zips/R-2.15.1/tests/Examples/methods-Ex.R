...
###   refClassRepresentation-class refObjectGenerator-class refClass-class
###   refObject-class refMethodDef-class refMethodDefWithTrace-class
###   SuperClassMethod-class show,envRefClass-method
